...
//      AppOpenAd.load(
//        context,
//        "ca-app-pub-8617754893098646/4783367556",
//        request,
...
//      if (isShowingAd) {
//        Log.d("openAds", "The app open ad is already showing.")
//        return
//      }
//
//      // If the app open ad is not available yet, invoke the callback.
//      if (!isAdAvailable()) {
//        Log.d("openAds", "The app open ad is not ready yet.")
...
//            appOpenAd = null
//            isShowingAd = false
//            Log.d("openAds", "onAdFailedToShowFullScreenContent: " + adError.message)
//
//            onShowAdCompleteListener.onShowAdComplete()
////            if (GoogleMobileAdsConsentManager.getInstance(activity).canRequestAds) {
////              loadAd(activity)
