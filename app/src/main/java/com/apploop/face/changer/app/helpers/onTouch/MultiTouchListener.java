...
public class MultiTouchListener implements OnTouchListener {
    ...
    StickerActivity.OnStickerTouch onStickerTouch;

    public void setOnMultiTouch(StickerActivity.OnStickerTouch onStickerTouch) {
        this.onStickerTouch = onStickerTouch;
    }
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (action & event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                if(onStickerTouch!=null){

                    this.onStickerTouch.onTouch(MotionEvent.ACTION_DOWN);
                }
                mPrevX = event.getX();
                mPrevY = event.getY();
            ...
            case MotionEvent.ACTION_UP:
                if(onStickerTouch!=null){
                    this.onStickerTouch.onTouch(MotionEvent.ACTION_UP);
                }
