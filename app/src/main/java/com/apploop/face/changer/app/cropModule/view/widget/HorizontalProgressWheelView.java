package com.apploop.face.changer.app.cropModule.view.widget;
...
public class HorizontalProgressWheelView extends View {
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), R.color.icon_color_red);
        ...
        mProgressLineMargin = getContext().getResources().getDimensionPixelSize(R.dimen.ucrop_margin_horizontal_wheel_progress_line1);

        mProgressLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mProgressLinePaint.setStyle(Paint.Style.STROKE);
        mProgressLinePaint.setStrokeWidth(getContext().getResources().getDimensionPixelSize(R.dimen.ucrop_width_middle_wheel_progress_line1));
        ...
        mProgressMiddleLinePaint.setStrokeWidth(getContext().getResources().getDimensionPixelSize(R.dimen.ucrop_width_middle_wheel_progress_line1));
    }
